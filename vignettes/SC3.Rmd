...
# To use all cores of your machine please just do not use this parameter:
# sce <- sc3(sce, ks = 2:4, biology = TRUE)
n_cores <- 1

sce <- sc3(sce, ks = 2:4, biology = TRUE, n_cores = n_cores)
```
...
```{r}
sce <- sc3_prepare(sce, n_cores = n_cores)
...
```{r}
sce <- sc3(sce, ks = 2:4, biology = TRUE, svm_num_cells = 50, n_cores = n_cores)
```
